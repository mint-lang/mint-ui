...
store Ui {
  const DEFAULT_FONT_CONFIGURATION =
    {
      ...
      titleName: "Nunito",
      regularWoff2:
        @asset(../assets/fonts/open-sans-v18-latin-ext_latin-regular.woff2),
      regularWoff:
        @asset(../assets/fonts/open-sans-v18-latin-ext_latin-regular.woff),
  ...
  const DEFAULT_TOKENS =
    [
      Ui.Token.Schemed(
        ...
        light: "#D0D0D0",
        dark: "#1A1A1A"),
      Ui.Token.Schemed(name: "background-color", light: "#F0F0F0", dark:
        "#222222"),
      Ui.Token.Schemed(name: "background-text", light: "#444444", dark: "#EEEEEE"),
      Ui.Token.Schemed(
        name: "content-faded-border",
        light: "#DDD",
        dark: "#242424"),
      Ui.Token.Schemed(name: "content-faded-color", light: "#EEE", dark:
        "#2C2C2C"),
      ...
      Ui.Token.Schemed(name: "shadow-color", light: "#00000010", dark:
        "#00000025"),
      ...
      Ui.Token.Schemed(
        ...
        light: "#D8EEFF",
        dark: "#354c5e"),
      Ui.Token.Schemed(name: "input-focus-text", light: "#306F9F", dark:
        "#A5CDEC"),
      Ui.Token.Schemed(
        name: "input-invalid-border",
        light: "#F4B0AB",
        dark: "#481B17"),
      Ui.Token.Schemed(
        name: "input-invalid-color",
        light: "#FDD3D0",
        dark: "#7D3E39"),
      Ui.Token.Schemed(
        name: "input-invalid-text",
        light: "#6A332F",
        dark: "#E8D1CF"),
      ...
      Ui.Token.Schemed(
        name: "warning-light-color",
        light: "#FFEDCE",
        dark: "#6A5021"),
      Ui.Token.Schemed(
        name: "warning-light-text",
        light: "#4a4740",
        dark: "#eee4cf"),
      ...
      Ui.Token.Schemed(
        name: "danger-light-color",
        light: "#FBE5E5",
        dark: "#752D2D"),
      Ui.Token.Schemed(
        name: "danger-light-text",
        light: "#463636",
        dark: "#e1b5b5"),
  ...
  state mediaQueryListener =
    Window.addMediaQueryListener("(max-width: 1000px)",
  ...
  fun setDarkMode (value : Bool) : Promise(Void) {
    case Storage.Local.set("ui.dark-mode", Bool.toString(value)) {
      Result.Err =>
        Debug.log("Could not save dark mode setting to LocalStorage!")
